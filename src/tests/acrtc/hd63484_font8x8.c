/**
 * hd63484_font8x8.c - built-in 8x8 font for the HD63484 text renderer
 *
 * ASCII 0x20..0x7E, one byte per row, MSB = leftmost pixel.
 *
 * Glyph data derived from font8x8_basic.h by Daniel Hepper, which is based on
 * the IBM public-domain VGA font via Marcel Sondaar. License: Public Domain.
 * (Bit order reversed from the original LSB-left layout.)
 */
#include "hd63484_text.h"

static const uint8_t font8x8_data[95 * 8] = {
...
const hd63484_font_t hd63484_font_8x8 = {
    8, 8, 0x20, 0x7E, font8x8_data
};